...
function quant(c, lo, hi)
	return (round(clamp(sub(hi, lo)*c + lo, lo, hi)))
end

function iquant(c, lo, hi)
...
function __call(self, ...) return self.xyz_(...) end

setmetatable(_ENV, {__call = function (self, data, ...)
	...
	write("-- Generated by "..arg[0].." -- DO NOT MODIFY\nreturn {\n")
